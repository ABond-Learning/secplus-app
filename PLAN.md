...
**Sub-batch 1 full corpus (next Audit D session, after Aiden sign-off on SB1.5 results).** Scope decision: match+cram only (1,251 items, $15-25) or +MC+scen (~2,200 items, $35-50). Model decision: sonnet-4-5 vs sonnet-4-6. Bump HARD_CAP. Run audit-d-llm-judge → apply audit-d-postprocess-verdicts → Aiden review of move-to-correct-video verdicts (now the post-process target).
